...
func (h *HostArray) GetInt(ctx *HostImpl, keyId int32) int64 {
...
func (h *HostArray) GetLength(ctx *HostImpl) int32 {
	return int32(len(h.items))
}

func (h *HostArray) GetObject(ctx *HostImpl, keyId int32, typeId int32) int32 {
...
func (h *HostArray) SetInt(ctx *HostImpl, keyId int32, value int64) {
	if !h.valid(ctx, keyId, objtype.OBJTYPE_INT_ARRAY) {
		return
	}
	if h.readonly {
...
func (h *HostArray) valid(ctx *HostImpl, keyId int32, typeId int32) bool {
	if h.typeId != typeId {
